...
The data model is updated using a Game class and a Player class, with 2 Player instances being created with each Game instance.  The DOM is updated based on the data model information.  LocalStorage is utilized to persist data upon page refresh.
